				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Enables Matomo script loading on the frontend using the settings from Developer › Settings.', 'fromscratch') ?></p>
						</td>
					</tr>
				</table>
