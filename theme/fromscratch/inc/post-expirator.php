...
add_action('enqueue_block_editor_assets', function () {
	...
	wp_localize_script('fromscratch-editor', 'fromscratchExpirator', [
		...
		'actionDraftShort' => __('Draft', 'fromscratch'),
		'actionDraftDesc' => __('Move this post to drafts so it is not publicly visible.', 'fromscratch'),
		'actionPrivate'   => __('Set to private', 'fromscratch'),
		'actionPrivateShort' => __('Private', 'fromscratch'),
		'actionPrivateDesc' => __('Only site administrators and editors can view the post.', 'fromscratch'),
		'actionRedirect'  => __('Redirect to another URL', 'fromscratch'),
		'actionRedirectShort' => __('Redirect', 'fromscratch'),
		'actionRedirectDesc' => __('Send visitors to another URL when they open this post.', 'fromscratch'),
