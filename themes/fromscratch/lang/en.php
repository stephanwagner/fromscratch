...
return [
    ...
    // Security tab
    'SETTINGS_SECURITY_HEADING_PASSWORD' => 'Site password',
    'SETTINGS_SECURITY_HEADING_LOGIN' => 'Login',
    'SETTINGS_SITE_PASSWORD_PROTECTION_LABEL' => 'Site password protection',
    'SETTINGS_SITE_PASSWORD_PROTECTION_CHECKBOX' => 'Protect entire site (frontend and admin) with a password',
    'SETTINGS_SITE_PASSWORD_PROTECTION_DESCRIPTION' => 'When enabled, visitors must enter a password before viewing any part of the site. Logged-in administrators and editors skip the prompt.',
    'SETTINGS_SITE_PASSWORD_LABEL' => 'Site password',
    'SETTINGS_SITE_PASSWORD_PLACEHOLDER' => 'Leave blank to keep current password',
    'SETTINGS_SITE_PASSWORD_DESCRIPTION' => 'Set or change the shared password.',
    ...
    'SITE_PASSWORD_FORM_NOTICE' => 'This site is protected. Enter the password to continue.',
    'SITE_PASSWORD_FORM_MESSAGE' => 'This site is protected. Enter the password to continue.',
    'SITE_PASSWORD_FORM_LABEL' => 'Password',
    'SITE_PASSWORD_FORM_SUBMIT' => 'Continue',
    'SITE_PASSWORD_FORM_ERROR' => 'Incorrect password. Please try again.',
    'SETTINGS_LOGIN_LIMIT_ATTEMPTS_LABEL' => 'Login attempts',
    'SETTINGS_LOGIN_LIMIT_ATTEMPTS_UNIT' => 'per minute',
    'SETTINGS_LOGIN_LIMIT_ATTEMPTS_DESCRIPTION' => 'After this many failed attempts per IP, login is blocked. Allowed range: %d - %d.',
