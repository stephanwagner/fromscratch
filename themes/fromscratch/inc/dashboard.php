...
?>
	<div class="fs-dashboard__panel">
		...
		<h2 class="fs-dashboard__title"><?php esc_html_e('FromScratch', 'fromscratch'); ?></h2>
		...
		<div class="fs-dashboard__sections">
			...
			<div class="fs-dashboard__section -stats">
				<strong><?= esc_html__('Today', 'fromscratch') ?>:</strong> <?= esc_html(sprintf(__('%1$s visits', 'fromscratch'), number_format_i18n($today_visits))) ?><br>
				<strong><?= esc_html__('Yesterday', 'fromscratch') ?>:</strong> <?= esc_html(sprintf(__('%1$s visits', 'fromscratch'), number_format_i18n($yesterday_visits))) ?><br>
		...
		<p class="fs-dashboard__description">
			<?php esc_html_e('Proudly presented by <a href="https://bytesandstripes.com" target="_blank">bytes and stripes GbR</a>.', 'fromscratch'); ?>
		</p>
