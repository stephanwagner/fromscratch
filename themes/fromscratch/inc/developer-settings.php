...
?>
	<div class="wrap">
		...
		<nav class="nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
			<?php
			foreach (FS_DEVELOPER_TABS as $slug => $def) {
				$icons = '';
				if ($slug === 'security') {
			...
			<div class="page-settings-form">
				...
				<form method="post" action="">
					...
					<div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
						...
						<input type="number" name="fromscratch_revisions_keep" id="fromscratch_revisions_keep" value="5" min="0" max="99" step="1" class="small-text" style="">
